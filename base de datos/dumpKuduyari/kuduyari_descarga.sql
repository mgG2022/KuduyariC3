...
CREATE TABLE `descarga` (
  ...
  PRIMARY KEY (`codigoDescarga`),
  KEY `fkUsuario_idx` (`codigoUsuario`),
  KEY `fkReceta_idx` (`codigoReceta`),
  CONSTRAINT `fkReceta` FOREIGN KEY (`codigoReceta`) REFERENCES `receta` (`codigoReceta`),
...
-- Dump completed on 2022-10-09 17:06:16
